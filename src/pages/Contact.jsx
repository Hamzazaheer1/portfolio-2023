    ...
    <section className="bg-[#f6fbff] opacity-100 px-5 w-full h-full absolute mt-16">
      ...
      <div class="py-10 lg:py-16 px-4 mx-auto max-w-screen-md">
        ...
        <form action="#" className="space-y-4">
          ...
          <button
            type="submit"
            class="bg-gray-600 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-primary-800 focus:ring-4 focus:outline-none focus:ring-primary-300"
          >
            Send message
          </button>
        </form>
      </div>
      <div className="pb-10 max-w-xs h-[500px]">
        <iframe
